...
evds_csv33_demo <- function(anahtar, 
                           veriseti1, 
                           veriseti2, 
                           veriseti3,
                           baslangic_tarihi, bitis_tarihi, 
                           islem1 = "", formul1 = "0", frekans1 = "2",
                           islem2 = "", formul2 = "0", frekans2 = "2",
                           islem3 = "", formul3 = "0", frekans3 = "2") {
  ...
  veridfbind = if("YEARWEEK" %in% colnames(veridf1)){
    full_join(veridfbind_1,veridf3,join_by(Tarih, YEARWEEK,UNIXTIME))
  }else{
    full_join(veridfbind_1,veridf3,join_by(Tarih, UNIXTIME))
  }
...
evds_csv33_demo(anahtar = anahtar,"TP.PR.ARZ01",
                veriseti2 = "TP.PR.ARZ13",
                veriseti3 = "TP.PR.ARZ22",
                baslangic_tarihi = "01-01-2006",bitis_tarihi = "01-03-2023")
