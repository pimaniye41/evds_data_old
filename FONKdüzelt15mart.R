evds_csv22_demo <- function(anahtar, 
                           veriseti1, 
                           veriseti2, 
...
a <- evds_csv22_demo(anahtar = anahtar,
                veriseti1 = "TP.RK.T1.Y",veriseti2 = "TP.RK.U01.Y",
                baslangic_tarihi = "01-01-2003",bitis_tarihi = format(Sys.Date(),"%d-%m-%Y"))
ggplot(a,aes(x = Tarih, group = seri))+
  geom_line(aes(y = deger))
